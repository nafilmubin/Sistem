    ...
    <div class="panel-body">
        <ul class="list-group list-group-unbordered">
            ...
            <li class="list-group-item">
             ...
             <li class="list-group-item">
                <b>Attachment</b> <span class="pull-right"><a href="download.php?page=<?php echo $data['attachment']; ?>" target="blank"><?php echo $data['attachment']; ?></span>
            </li>
            <li class="list-group-item">
                <b>Tanggal</b> <span class="pull-right"><?php echo $data['periode']; ?></span>
            </li>
            <li class="list-group-item">
